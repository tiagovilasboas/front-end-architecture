...
description: 'Explore a Clean Architecture no front-end, um padrão que isola a lógica de negócio das frameworks e da UI, promovendo reusabilidade, testabilidade e independência de tecnologia.'
icon: 'gem'
category: 'Arquiteturas de Aplicação'
---

A Clean Architecture é um daqueles conceitos que, quando você entende, muda a forma como você escreve código para sempre. Proposta originalmente por Robert C. Martin (Uncle Bob) para o back-end, a ideia é 100% aplicável ao front-end. E, na minha opinião, é onde ela mais brilha.
