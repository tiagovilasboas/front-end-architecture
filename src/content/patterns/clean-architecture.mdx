---
title: 'Clean Architecture: Isolando o Coração da sua Aplicação'
description: 'Uma visão sobre a Clean Architecture no front-end, um padrão que protege sua lógica de negócios de frameworks e bibliotecas, promovendo um código testável, reutilizável e que dura mais.'
icon: 'clean'
