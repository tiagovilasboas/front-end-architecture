---
title: 'Arquitetura de Ilhas: O Melhor de Dois Mundos'
description: 'Uma explicação sobre a Arquitetura de Ilhas, o padrão que nos devolveu a velocidade da web estática sem sacrificar a interatividade das SPAs.'
icon: 'component'
