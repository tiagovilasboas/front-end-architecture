---
title: 'Desenvolvimento Orientado a Componentes: A Oficina da sua UI'
description: 'Uma introdução ao CDD (Component-Driven Development), a prática de construir componentes de UI isoladamente, como se fossem produtos, para criar sistemas mais robustos, consistentes e fáceis de colaborar.'
icon: 'puzzle'
