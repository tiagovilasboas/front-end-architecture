---
title: 'Jamstack: A Volta Triunfal dos Sites Estáticos'
description: 'Uma introdução à filosofia Jamstack (JavaScript, APIs e Markup), a abordagem que está tornando a web mais rápida, segura e escalável ao pré-construir o máximo possível.'
icon: 'file-stack'
