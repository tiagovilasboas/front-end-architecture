...
description: 'Descubra a abordagem de Micro-frontends, que aplica os conceitos de micro-serviços ao front-end para permitir que equipes autônomas desenvolvam e implantem partes de uma UI de forma independente.'
icon: 'blocks'
layout: '../../layouts/ContentLayout.astro'
category: 'Arquiteturas de Aplicação'
---

Micro-frontends é um daqueles padrões que, quando você precisa, é um salva-vidas. Mas se você usar sem precisar, é como usar um canhão para matar uma formiga. Eu já vi os dois cenários.
