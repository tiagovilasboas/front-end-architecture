...
description: 'Uma abordagem para desenvolver aplicações web como uma composição de partes semi-independentes, cada uma gerenciada por uma equipe diferente.'
icon: 'micro'
